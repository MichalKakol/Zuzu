...
if (isset($_POST['Verzenden'])) {
    setcookie("kom", $_POST['kom'], time() + 30);
    setcookie("avo", $_POST['avo'], time() + 30);
    setcookie("nigirl", $_POST['nigirl'], time() + 30);
    setcookie("phil", $_POST['phil'], time() + 30);
    setcookie("tuna", $_POST['tuna'], time() + 30);
    setcookie("cali", $_POST['cali'], time() + 30);
